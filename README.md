...
WARNING : This version of the import format is compatible with Moodle 2.2.7 and ulteriors
versions of Moodle 2.2.x. Unfortunately there is no version of this plugin available for Moodle versions from 2.2 to
2.2.6 because it depends on changes that have been made to Moodle in MDL-36243 tracker issue,
